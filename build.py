...
PROPERTIES = [
 ...
 dict(slug="mens-pg-janardhan-hills", name="Aadhya Green Home – Gachibowli, Gachibowli", short="Men's PG · Janardhan Hills",
 ...
 dict(slug="womens-pg-prashant-hills", name="Aadhya Women's PG – Khajaguda, Khajaguda", short="Women's PG · Prashant Hills",
...
# careers.html is HAND-MAINTAINED: it is now a redirect to benefits.html (the
# hand-edited Benefits & Career Opportunities page). The generator must NOT
# write careers.html or benefits.html — only GoogleAI_Job_Roles.html still
# comes from build_careers().
